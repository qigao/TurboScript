...
spec("IO Module") {
    ...
    describe("Sanity Check") {
        it("should evaluate basic math") {
            ...
            check(fabs((double)(val) - (double)(2.0)) <= (double)(TEST_TOLERANCE));
        }
        ...
        it("should call date_diff directly") {
            ...
            double val = value_to_double(result);
            check(fabs((double)(val) - (double)(500.0)) <= (double)(TEST_TOLERANCE));
        }
    ...
    describe("listdir()") {
        it("should list directory contents") {
            ...
            check(((int)result.data.list.count) == (3));
            
            /* Verify entries are strings */
            if (result.data.list.count >= 1) {
                check((result.data.list.items[0].type) == (EXPRTK_VAL_STRING));
            }
        }
        ...
        it("should return empty list for empty directory") {
            ...
            check((result.type) == (EXPRTK_VAL_LIST));
            check(((int)result.data.list.count) == (0));
        ...
        it("should return 0 for non-existent directory") {
            ...
            check(fabs((double)(result.data.number) - (double)(0.0)) <= (double)(TEST_TOLERANCE));
        }
    ...
    describe("glob()") {
        it("should list paths matching a wildcard pattern") {
            ...
            exprtk_value_t result = eval_script(code);
            check((result.type) == (EXPRTK_VAL_LIST));
            check(((int)result.data.list.count) == (2));

            for (size_t i = 0; i < result.data.list.count; i++) {
                check((result.data.list.items[i].type) == (EXPRTK_VAL_STRING));
    ...
    describe("file operations") {
        it("should copy and truncate files") {
            ...
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(3.0)) <= (double)(TEST_TOLERANCE));
    ...
    describe("recursive directories") {
        it("should create and remove nested directories") {
            ...
            exprtk_value_t result = eval_script(code);
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(1.0)) <= (double)(TEST_TOLERANCE));
            rmdir(root);
        }
    }
    ...
    describe("date_add()") {
        it("should add days to timestamp") {
            ...
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(0.0)) <= (double)(1.0)); /* Allow 1 second tolerance */
        }
        ...
        it("should add days and hours") {
            ...
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(0.0)) <= (double)(1.0));
        }
    ...
    describe("date_diff()") {
        it("should calculate difference in seconds") {
            ...
            check(fabs((double)(result.data.number) - (double)(604800.0)) <= (double)(1.0));
        }
        ...
        it("should calculate difference in days") {
            ...
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(7.0)) <= (double)(0.01));
        }
    }
    ...
    describe("date_components()") {
        it("should decompose date into components") {
            ...
            check(((int)result.data.vector.size) == (7));
            
            /* Components: [year, month, day, hour, minute, second, weekday] */
            check(fabs((double)(result.data.vector.data[0]) - (double)(2024.0)) <= (double)(TEST_TOLERANCE)); /* year */
            check(fabs((double)(result.data.vector.data[1]) - (double)(6.0)) <= (double)(TEST_TOLERANCE));    /* month */
            check(fabs((double)(result.data.vector.data[2]) - (double)(15.0)) <= (double)(TEST_TOLERANCE));   /* day */
    ...
    describe("year_day()") {
        ...
        it("should handle leap year") {
            ...
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(366.0)) <= (double)(TEST_TOLERANCE));
        }
        ...
        it("should handle non-leap year") {
            ...
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(365.0)) <= (double)(TEST_TOLERANCE));
        }
    }
    ...
    describe("Integration") {
        ...
        it("should use date functions together") {
            ...
            check((result.type) == (EXPRTK_VAL_NUMBER));
            check(fabs((double)(result.data.number) - (double)(30.0)) <= (double)(0.01));
        }
    }
}
