...
int ts_mir_set_var_class(ts_mir_compiler_t *c, const char *var_name, const char *class_name);
...
int ts_find_math_dispatch(ts_mir_compiler_t *c, const char *name, size_t argc, MIR_item_t *proto,
                          MIR_item_t *import);
...
MIR_reg_t ts_emit_runtime_call_assign(ts_mir_compiler_t *c, const char *target_name,
                                      const char *name, size_t argc, exprtk_node_t **arg_nodes);
...
MIR_reg_t ts_emit_member_access(ts_mir_compiler_t *c, const char *obj_name, const char *member,
...
int ts_oop_call_args_need_value_bridge(ts_mir_compiler_t *c, size_t argc, exprtk_node_t **args);
...
int ts_try_emit_typeof_oop_compare(ts_mir_compiler_t *c, exprtk_node_t *left, exprtk_node_t *right,
                                   int op, MIR_reg_t *out);
MIR_reg_t ts_emit_oop_member_call_value(ts_mir_compiler_t *c, const char *object_name,
                                        ...
                                        exprtk_node_t *call_node);
MIR_reg_t ts_emit_oop_member_call_mono_value(ts_mir_compiler_t *c, const char *object_name,
                                             const char *expected_class_name,
                                             const char *method_name, exprtk_node_t *object_node,
                                             exprtk_node_t *call_node);
MIR_reg_t ts_emit_oop_member_call_cached(ts_mir_compiler_t *c, const char *object_name,
                                         const char *method_name, exprtk_node_t *object_node,
                                         size_t argc, const MIR_reg_t *arg_regs, int reload_after);
...
MIR_reg_t ts_emit_oop_member_call_assign_value(ts_mir_compiler_t *c, const char *target_name,
                                               const char *object_name, const char *method_name,
                                               exprtk_node_t *object_node,
                                               exprtk_node_t *call_node);
...
MIR_reg_t ts_try_emit_oop_inline_method_call(ts_mir_compiler_t *c, const char *object_name,
...
double ts_mir_call_assign(void *ctx_ptr, const char *target, const char *name, int64_t count,
                          double *args);
...
double ts_mir_destructure_var(void *ctx_ptr, void *target, const char *value_name,
                              int64_t is_constant);
double ts_mir_destructure_vector(void *ctx_ptr, void *target, int64_t is_constant, int64_t count,
                                 double *values);
...
double ts_mir_member_get(void *ctx_ptr, const char *obj_name, const char *member, void *cache_ptr,
                         void *object_node);
...
double ts_mir_call_host_slot(void *registry_owner_ptr, void *runtime_ctx_ptr, int64_t slot,
...
double ts_mir_oop_new_assign(void *ctx_ptr, const char *target, const char *class_name,
                             int64_t argc, double *argv);
double ts_mir_oop_member_call(void *ctx_ptr, const char *obj, const char *method, void *object_node,
                              int64_t argc, double *argv);
double ts_mir_oop_member_call_cached(void *ctx_ptr, const char *obj, const char *method,
                                     void *cache, void *object_node, int64_t argc, double *argv);
double ts_mir_oop_member_call_assign(void *ctx_ptr, const char *target, const char *obj,
                                     ...
                                     int64_t argc, double *argv);
double ts_mir_oop_member_call_value(void *ctx_ptr, const char *obj, const char *method,
                                    void *object_node, void *call_node);
double ts_mir_oop_member_call_mono_value(void *ctx_ptr, const char *obj, const char *class_name,
                                         const char *method, void *object_node, void *call_node);
double ts_mir_oop_member_call_assign_value(void *ctx_ptr, const char *target, const char *obj,
                                           const char *method, void *object_node, void *call_node);
double ts_mir_oop_member_get(void *ctx_ptr, const char *obj, const char *field, void *cache_ptr,
                             void *object_node);
double ts_mir_oop_member_set(void *ctx_ptr, const char *obj, const char *field, void *cache_ptr,
                             void *object_node, double value);
void *ts_mir_oop_num_ptr(void *ctx_ptr, const char *obj, const char *field, void *object_node,
                         int64_t create_if_missing, void *slot_cache_ptr);
...
MIR_reg_t ts_emit_call_value_assign(ts_mir_compiler_t *c, const char *target_name, const char *name,
                                    exprtk_node_t *call_node);
...
int ts_oop_member_can_use_num_slot(ts_mir_compiler_t *c, const char *object_name,
                                   const char *member_name);
exprtk_node_t *ts_find_inlineable_instance_method(ts_mir_compiler_t *c, const char *class_name,
                                                  const char *method_name, size_t argc);
