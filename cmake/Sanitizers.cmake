...
if(ENABLE_SANITIZER_ADDRESS OR ENABLE_SANITIZER_UNDEFINED OR ENABLE_SANITIZER_LEAK OR 
   ENABLE_SANITIZER_THREAD OR ENABLE_SANITIZER_MEMORY)
    ...
    if(SANITIZER_LINK_FLAGS)
        list(JOIN SANITIZER_LINK_FLAGS " " _SANITIZER_LINK_FLAGS_STR)
        string(APPEND CMAKE_EXE_LINKER_FLAGS " ${_SANITIZER_LINK_FLAGS_STR}")
        string(APPEND CMAKE_SHARED_LINKER_FLAGS " ${_SANITIZER_LINK_FLAGS_STR}")
        string(APPEND CMAKE_MODULE_LINKER_FLAGS " ${_SANITIZER_LINK_FLAGS_STR}")
    endif()

    if(MSVC AND ENABLE_SANITIZER_ADDRESS)
        string(APPEND CMAKE_EXE_LINKER_FLAGS " /STACK:8388608")
    endif()
